...
export function ChargerStatusGrid() {
  ...
  return (
    <div className="space-y-6">
      {/* Summary Header */}
      <Card className="border-[#3A2415] bg-[#2A1A0F]">
        <CardHeader>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-[#D4A56A]/10 border border-[#D4A56A]/40">
              <div>
                <div className="text-sm sm:text-base text-white/60">充電中</div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#D4A56A]">
                  {statusCounts.charging}
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-[#7D9B7E]/10 border border-[#7D9B7E]/40">
              <div>
                <div className="text-sm sm:text-base text-white/60">可用</div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#7D9B7E]">
                  {statusCounts.available}
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-[#241508] border border-[#3A2415]">
              <div>
                <div className="text-sm sm:text-base text-white/60">離線</div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white/50">
            ...
            >
              ...
              <CardContent className="space-y-2">
                ...
                {charger.status === "charging" && (
                  <div className="pt-2">
                    <div className="flex items-center justify-between text-sm sm:text-base">
                      <span className="text-white/60">功率</span>
                      <span
                ...
                {charger.status === "available" && (
                  <div className="text-sm sm:text-base text-white/60 pt-2">
                    準備就緒
                  </div>
                )}
