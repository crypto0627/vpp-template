        ...
        <div className="py-4 sm:py-6">
          ...
          >
            ...
            <div className="absolute bottom-0 right-[8%] flex flex-col items-center gap-3">
              <div className="relative group">
                <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-[#241508] border-3 border-[#3A2415] flex flex-col items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-300">
          ...
          {/* Flow Explanation */}
          <div className="mt-6 sm:mt-8 pt-4 sm:pt-5 border-t border-[#3A2415]">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-sm sm:text-base">
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/60">電網供電</span>
                  <span className="text-white font-bold ml-auto text-base">
                ...
                {isDischarging && (
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white/60">儲能放電</span>
                    <span className="text-white font-bold ml-auto text-base">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-4 h-4 rounded-full bg-[#3A2415]"></div>
                  <span className="text-white/60">充電樁負載</span>
                  <span className="text-white font-bold ml-auto text-base">
                ...
                {isCharging && (
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white/60">儲能充電</span>
                    <span className="text-white font-bold ml-auto text-base">
                      {energyFlow.bessPower} kW
                    </span>
                  </div>
          ...
          {/* Status Indicator */}
          <div className="mt-4 sm:mt-5 p-3 sm:p-4 rounded-lg bg-[#1E1208] border border-[#3A2415]">
            <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-2 sm:gap-0">
              <div className="flex items-center gap-3">
                <div
                  className={`w-3 h-3 rounded-full ${isCharging ? "bg-[#D4A56A]" : isDischarging ? "bg-[#7D9B7E]" : "bg-[#3A2415]"}`}
                ></div>
