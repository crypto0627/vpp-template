        ...
        <div className="mt-3 sm:mt-4 space-y-2 sm:space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-sm sm:text-base">
            ...
            <div className="flex items-center gap-2">
              ...
              ></div>
              <span className="text-white/50">儲能充電 (離峰)</span>
            </div>
            <div className="flex items-center gap-2">
              <div
          ...
          {/* Statistics */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-sm sm:text-base pt-2 border-t border-[#3A2415]">
            <div className="text-white/50 flex justify-between sm:block">
              <span>平均功率:</span>
          ...
          <div className="pt-4 border-t border-[#3A2415]">
            <h3 className="text-base sm:text-lg font-semibold text-white/50 mb-3">
              放電時段與費率
            </h3>
