    ...
    <Card className="border-[#3A2415] bg-[#2A1A0F]">
      <CardHeader>
        ...
        <div className="text-right">
          ...
          <div className="text-sm sm:text-base text-white/60">當前 SOC</div>
        </div>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          {/* SOC Progress Bar */}
          <div className="relative h-10 sm:h-12 bg-[#2A1A0F] rounded-full overflow-hidden">
            <div
          ...
          <div className="pt-4 border-t border-[#3A2415]">
            <h3 className="text-base sm:text-lg font-semibold text-white/60 mb-3">
              設備規格
            </h3>
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              ...
              {/* PCS Capacity */}
              <div className="space-y-1">
                <div className="text-xs sm:text-sm text-white/60">PCS 功率</div>
                <div className="text-lg sm:text-xl font-bold text-white">
              ...
              {/* Current SOC */}
              <div className="space-y-1">
                <div className="text-xs sm:text-sm text-white/60">當前 SOC</div>
                <div className="text-lg sm:text-xl font-bold text-white">
                  {batteryData.soc}%
          ...
          <div className="pt-4 border-t border-[#3A2415]">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center pt-2 border-t border-[#3A2415]">
                <span className="text-xs sm:text-sm text-white/60">
                  運作狀態
                </span>
                <span className="text-sm sm:text-base font-semibold text-white">
