...
export namespace Prisma {
  ...
  */
      ...
      UsageMetric: {
        ...
        operations: {
          ...
          count: {
            ...
            result:
              | $Utils.Optional<UsageMetricCountAggregateOutputType>
              | number;
          };
        };
      };
   ...
   * UserCountOutputType without action
   */
  export type UserCountOutputTypeCountUsageMetricsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
   ...
   */
  export type ChatSessionCountOutputTypeDefaultArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   * ChatSessionCountOutputType without action
   */
  export type ChatSessionCountOutputTypeCountMessagesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    chatSessions<T extends User$chatSessionsArgs<ExtArgs> = {}>(
      ...
      | Null
    >;
    usageMetrics<T extends User$usageMetricsArgs<ExtArgs> = {}>(
      args?: Subset<T, User$usageMetricsArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
   ...
   * User.usageMetrics
   */
  export type User$usageMetricsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
    ...
    where?: UsageMetricWhereInput;
    orderBy?:
      | UsageMetricOrderByWithRelationInput
      | UsageMetricOrderByWithRelationInput[];
  ...
  export type ChatSessionOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    "id" | "userId" | "title" | "lastMessageAt" | "createdAt",
    ExtArgs["result"]["chatSession"]
  >;
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    user<T extends UserDefaultArgs<ExtArgs> = {}>(
      ...
      GlobalOmitOptions
    >;
    messages<T extends ChatSession$messagesArgs<ExtArgs> = {}>(
      args?: Subset<T, ChatSession$messagesArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
   ...
   */
  export type ChatSession$messagesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise";
    session<T extends ChatSessionDefaultArgs<ExtArgs> = {}>(
      args?: Subset<T, ChatSessionDefaultArgs<ExtArgs>>,
    ): Prisma__ChatSessionClient<
      | $Result.GetResult<
          Prisma.$ChatSessionPayload<ExtArgs>,
          T,
  ...
  > = {
    where?: UsageMetricWhereInput;
    orderBy?:
      | UsageMetricOrderByWithAggregationInput
      | UsageMetricOrderByWithAggregationInput[];
  ...
  type GetUsageMetricGroupByPayload<T extends UsageMetricGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
        PickEnumerable<UsageMetricGroupByOutputType, T["by"]> & {
          [P in keyof T &
            keyof UsageMetricGroupByOutputType]: P extends "_count"
            ? T[P] extends boolean
              ? number
  ...
  type UsageMetricGetPayload<
    S extends boolean | null | undefined | UsageMetricDefaultArgs,
  > = $Result.GetResult<Prisma.$UsageMetricPayload, S>;

  type UsageMetricCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = Omit<
    UsageMetricFindManyArgs,
    "select" | "include" | "distinct" | "omit"
  > & {
  ...
  > {
    ...
    >(
      args: SubsetIntersection<T, UsageMetricGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetUsageMetricGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
    /**
  ...
  > = {
    ...
    data: XOR<
      ...
      UsageMetricUncheckedUpdateManyInput
    >;
    /**
   ...
   */
  export type EnumMessageContentTypeFieldRefInput<$PrismaModel> =
    FieldRefInputType<$PrismaModel, "MessageContentType">;

  /**
   * Reference to a field of type 'MessageContentType[]'
   */
  export type ListEnumMessageContentTypeFieldRefInput<$PrismaModel> =
    FieldRefInputType<$PrismaModel, "MessageContentType[]">;
  ...
  export type ChatSessionWhereInput = {
    ...
    lastMessageAt?:
      | DateTimeNullableFilter<"ChatSession">
      | Date
      | string
      | null;
  ...
  export type ChatSessionScalarWhereWithAggregatesInput = {
    ...
    lastMessageAt?:
      | DateTimeNullableWithAggregatesFilter<"ChatSession">
      | Date
      | string
      | null;
  ...
  export type MessageWhereInput = {
    ...
    contentType?:
      | EnumMessageContentTypeFilter<"Message">
  ...
  export type MessageScalarWhereWithAggregatesInput = {
    ...
    contentType?:
      | EnumMessageContentTypeWithAggregatesFilter<"Message">
      | $Enums.MessageContentType;
  ...
  export type UsageMetricScalarWhereWithAggregatesInput = {
    AND?:
      | UsageMetricScalarWhereWithAggregatesInput
      | UsageMetricScalarWhereWithAggregatesInput[];
  ...
  export type MessageUpdateInput = {
    ...
    contentType?:
      | EnumMessageContentTypeFieldUpdateOperationsInput
      | $Enums.MessageContentType;
    chartConfig?: NullableJsonNullValueInput | InputJsonValue;
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string;
  ...
  export type EnumMessageContentTypeFilter<$PrismaModel = never> = {
    equals?:
      | $Enums.MessageContentType
      | EnumMessageContentTypeFieldRefInput<$PrismaModel>;
    in?:
      | $Enums.MessageContentType[]
      | ListEnumMessageContentTypeFieldRefInput<$PrismaModel>;
    notIn?:
      | $Enums.MessageContentType[]
      | ListEnumMessageContentTypeFieldRefInput<$PrismaModel>;
    not?:
      | NestedEnumMessageContentTypeFilter<$PrismaModel>
      | $Enums.MessageContentType;
  };
  ...
  export type EnumMessageContentTypeWithAggregatesFilter<$PrismaModel = never> =
    {
      ...
      notIn?:
        ...
        | ListEnumMessageContentTypeFieldRefInput<$PrismaModel>;
      not?:
        | NestedEnumMessageContentTypeWithAggregatesFilter<$PrismaModel>
        | $Enums.MessageContentType;
      _count?: NestedIntFilter<$PrismaModel>;
  ...
  export type UsageMetricCreateNestedManyWithoutUserInput = {
    create?:
      | XOR<
          UsageMetricCreateWithoutUserInput,
          UsageMetricUncheckedCreateWithoutUserInput
        >
      | UsageMetricCreateWithoutUserInput[]
      | UsageMetricUncheckedCreateWithoutUserInput[];
    connectOrCreate?:
      | UsageMetricCreateOrConnectWithoutUserInput
      | UsageMetricCreateOrConnectWithoutUserInput[];
  ...
  export type UsageMetricUpdateManyWithoutUserNestedInput = {
    ...
    connectOrCreate?:
      ...
      | UsageMetricCreateOrConnectWithoutUserInput[];
    upsert?:
      | UsageMetricUpsertWithWhereUniqueWithoutUserInput
      | UsageMetricUpsertWithWhereUniqueWithoutUserInput[];
    createMany?: UsageMetricCreateManyUserInputEnvelope;
    ...
    connect?: UsageMetricWhereUniqueInput | UsageMetricWhereUniqueInput[];
    update?:
      | UsageMetricUpdateWithWhereUniqueWithoutUserInput
      | UsageMetricUpdateWithWhereUniqueWithoutUserInput[];
    updateMany?:
      | UsageMetricUpdateManyWithWhereWithoutUserInput
      | UsageMetricUpdateManyWithWhereWithoutUserInput[];
  ...
  export type MessageCreateNestedManyWithoutSessionInput = {
    create?:
      | XOR<
          MessageCreateWithoutSessionInput,
          MessageUncheckedCreateWithoutSessionInput
        >
      | MessageCreateWithoutSessionInput[]
      | MessageUncheckedCreateWithoutSessionInput[];
    connectOrCreate?:
      | MessageCreateOrConnectWithoutSessionInput
      | MessageCreateOrConnectWithoutSessionInput[];
  ...
  export type MessageUpdateManyWithoutSessionNestedInput = {
    ...
    connectOrCreate?:
      ...
      | MessageCreateOrConnectWithoutSessionInput[];
    upsert?:
      | MessageUpsertWithWhereUniqueWithoutSessionInput
      | MessageUpsertWithWhereUniqueWithoutSessionInput[];
    createMany?: MessageCreateManySessionInputEnvelope;
    ...
    connect?: MessageWhereUniqueInput | MessageWhereUniqueInput[];
    update?:
      | MessageUpdateWithWhereUniqueWithoutSessionInput
      | MessageUpdateWithWhereUniqueWithoutSessionInput[];
    updateMany?:
      | MessageUpdateManyWithWhereWithoutSessionInput
      | MessageUpdateManyWithWhereWithoutSessionInput[];
  ...
  export type UserCreateNestedOneWithoutUsageMetricsInput = {
    create?: XOR<
      UserCreateWithoutUsageMetricsInput,
      UserUncheckedCreateWithoutUsageMetricsInput
    >;
  ...
  export type UserUpdateOneRequiredWithoutUsageMetricsNestedInput = {
    ...
    update?: XOR<
      XOR<
        UserUpdateToOneWithWhereWithoutUsageMetricsInput,
        UserUpdateWithoutUsageMetricsInput
      >,
      UserUncheckedUpdateWithoutUsageMetricsInput
    >;
  };
  ...
  export type UsageMetricUpsertWithWhereUniqueWithoutUserInput = {
    where: UsageMetricWhereUniqueInput;
    update: XOR<
      UsageMetricUpdateWithoutUserInput,
      UsageMetricUncheckedUpdateWithoutUserInput
    >;
    create: XOR<
      UsageMetricCreateWithoutUserInput,
      UsageMetricUncheckedCreateWithoutUserInput
  ...
  export type UsageMetricUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<
      UsageMetricUpdateManyMutationInput,
      UsageMetricUncheckedUpdateManyWithoutUserInput
    >;
  };
  ...
  export type MessageUpsertWithWhereUniqueWithoutSessionInput = {
    where: MessageWhereUniqueInput;
    update: XOR<
      MessageUpdateWithoutSessionInput,
      MessageUncheckedUpdateWithoutSessionInput
    >;
    create: XOR<
      MessageCreateWithoutSessionInput,
      MessageUncheckedCreateWithoutSessionInput
  ...
  export type MessageUpdateManyWithWhereWithoutSessionInput = {
    ...
    data: XOR<
      ...
      MessageUncheckedUpdateManyWithoutSessionInput
    >;
  };
