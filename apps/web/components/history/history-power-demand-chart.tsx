        ...
        <div className="mt-3 space-y-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-sm">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-gray-500">實際用電 (負載+充電)</span>
            </div>
            <div className="flex items-center gap-2">
              <div
                className="w-4 h-4 rounded shrink-0"
              ...
              />
              <span className="text-gray-500">用電負載</span>
            </div>
            <div className="flex items-center gap-2">
              <div
                className="w-4 h-4 rounded shrink-0"
              ...
              />
              <span className="text-gray-500">儲能放電</span>
            </div>
            <div className="flex items-center gap-2">
              <div
                className="w-4 h-4 rounded shrink-0"
              ...
              />
              <span className="text-gray-500">儲能充電</span>
            </div>
            <div className="flex items-center gap-2">
              <div
                className="w-4 h-4 rounded shrink-0"
              ...
              />
              <span className="text-gray-500">儲能作用</span>
            </div>
            <div className="flex items-center gap-2">
              <div
          ...
          {/* Stats */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm pt-2 border-t border-gray-200">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {chartData.map((d) => (
                    ...
                    >
                      <td className="py-1.5 px-2 text-gray-700">{d.time}</td>
